-- twinemidiseek
-- edited version of twine to be
-- played with midi keyboard
--
-- by: @antipath 
-- original: @cfd90
--
...
function midi_control(data)
  msg = midi.to_msg(data)
  if msg.type == "note_on" then
    params:set("1seek", msg.note)
    params:set("2seek", msg.note)
    params:set("1volume", 0)
    params:set("2volume", 0)
  elseif msg.type == "note_off" then
    if params:get("1seek") == msg.note then
      params:set("1volume", -60)
